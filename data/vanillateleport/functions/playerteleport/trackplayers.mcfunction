...
execute as @e[tag=p] run scoreboard players operation @s idCheck = @s id
scoreboard players operation @e[tag=p] idCheck -= @e[tag=a2,scores={tpInstanceCheck=0}] tpid
tp @e[tag=a2,scores={tpInstanceCheck=0}] @e[tag=p,scores={idCheck=0},limit=1]
execute as @e[tag=p] run scoreboard players operation @s idCheck = @s id
scoreboard players operation @e[tag=p] idCheck -= @e[tag=a3,scores={tpInstanceCheck=0}] tpid
tp @e[tag=a3,scores={tpInstanceCheck=0}] @e[tag=p,scores={idCheck=0},limit=1]
execute as @e[tag=p] run scoreboard players operation @s idCheck = @s id
scoreboard players operation @e[tag=p] idCheck -= @e[tag=a4,scores={tpInstanceCheck=0}] tpid
tp @e[tag=a4,scores={tpInstanceCheck=0}] @e[tag=p,scores={idCheck=0},limit=1]
execute as @e[tag=p] run scoreboard players operation @s idCheck = @s id
scoreboard players operation @e[tag=p] idCheck -= @e[tag=a5,scores={tpInstanceCheck=0}] tpid
